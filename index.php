...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <div class="mdl-layout__drawer">
        <span class="mdl-layout-title"><b>Menú</b></span>
        <nav class="mdl-navigation">
            <a class="mdl-navigation__link" href="index.php"><b>Incio</b></a>
            <a class="mdl-navigation__link" href="temas/Variableyalgoritmo/v-a.php"><b>Variable y algoritmo</b></a>
            <a class="mdl-navigation__link" href=""><b>Sentencia if else y elseif</b></a>
            <a class="mdl-navigation__link" href="temas/Estructurasderepeticion/index.php"><b>Estructuras de Repetecion</b></a>
            <a class="mdl-navigation__link" href="">Link</a>
        </nav>
    </div>
        ...
        <div class="mdl-card mdl-shadow--4dp mdl-cell mdl-cell--6-col-tablet mdl-cell--8-col-desktop mdl-cell--4-col-phone">
          ...
          <div class="mdl-card__supporting-text">
                  ...
                  <pre class="sh_cpp">
                        ...
                        4- Escribir "Hola, buenos días";<br>
                        5- Escribir "Hola, buenos días";<br>
                        6- Escribir "Hola, buenos días";<br>
                        7- Escribir "Hola, buenos días";<br>
                        8- Escribir "Hola, buenos días";<br>
                        9- Escribir "Hola, buenos días";<br>
                        10- Escribir "Hola, buenos días";<br>
                        11- Fin
                          </pre>
          </div>
        </div>
