...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="../Variableyalgoritmo/v-a.php"><b>Variable y algoritmo</b></a>
            <a class="mdl-navigation__link" href=""><b>Sentencia if else y elseif</b></a>
            <a class="mdl-navigation__link" href="../Estructurasderepeticion/index.php"><b>Estructuras de Repetecion</b></a>
            <a class="mdl-navigation__link" href="">Link</a>
        </nav>
    </div>
